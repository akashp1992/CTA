...
import FileAnim from "./animationIcons/FileAnim";
  ...
  return (
    <div className={classes.main}>
      ...
      <p className={classes.description}>
        The Corporate Transparency Act (CTA) is a law enacted by Congress,
        requiring certain corporations and limited liability companies
        (reporting companies) to disclose beneficial owner information to FinCEN
        and update ownership information within one year of any changes.
      </p>
      ...
      <div className={classes.cards}>
        <div className={classes.container}>
          ...
          <Grid item container>
            <Grid lg={3} xl={3} className={classes.contain}>
